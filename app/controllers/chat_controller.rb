...
class DiscourseChat::ChatController < ApplicationController
  ...
  def create_rule
    begin
      hash = params.require(:rule).permit(:channel_id, :type, :filter, :style, :group_id, :category_id, tags: [])
  ...
  def update_rule
    begin
      ...
      hash = params.require(:rule).permit(:type, :filter, :style, :group_id, :category_id, tags: [])
